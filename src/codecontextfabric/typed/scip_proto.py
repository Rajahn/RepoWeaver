...
Only the messages Code Context Fabric's typed overlay needs are decoded: Index,
...
# SymbolRole bitmask (scip.proto `SymbolRole` enum) — only the bit Code Context Fabric
