...
from codecontextfabric.benchmark.adapters import AdapterSkipped, build_adapter
...
def run_benchmark(
    ...
    with tempfile.TemporaryDirectory(prefix="codecontextfabric-benchmark-") as tmp:
        workdir = Path(tmp)
        try:
