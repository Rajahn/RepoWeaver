...
from codecontextfabric.benchmark.compare import compare as compare_metrics
from codecontextfabric.benchmark.report import render_report
from codecontextfabric.benchmark.runner import run_benchmark

app = typer.Typer(
    name="benchmark",
    help="Measure and compare Code Context Fabric against SOTA alignment targets.",
...
def run(
    ...
    adapter: str = typer.Option(
        "ccf",
        "--adapter",
        help="ccf | grep | codegraph | graft | external:<shell command>",
    ),
